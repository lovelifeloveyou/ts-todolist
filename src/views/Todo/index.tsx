...
class Todo extends React.Component<ITodoProps, IState> {
  ...
  public render () {
    const filterTodo = this.props.todo.filter(v => v.status === this.state.resolvedStatus)
      ...
      <div className='todo-wrapper'>
        ...
        <div className='todo-main'>
          <ul className='todo-nav'>
            ...
            <li
              className={this.state.resolvedStatus ? 'active' : ''}
              onClick={() => this.handleShowResolved(true)}
            >
...
const mapDispatchToProps = (dispatch: Dispatch) => ({
  ...
  updateTodoStatus: (todoId: Partial<ITodoState>) => dispatch(updateTodoStatus(todoId)),
  updateTodoContent: (todo: Partial<ITodoState>) => dispatch(updateTodoContent(todo)),
  searchTodo: (todo: Partial<ITodoState & { q: string }>) => dispatch(searchTodo(todo))
})
